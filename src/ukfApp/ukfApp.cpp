 ...
 *
 */
Eigen::VectorXd ukfApp:: PredictionModel (const Eigen::Ref<const Eigen::VectorXd> &sig_pred_,const void *args)
{
 ...
 *
 */
Eigen::VectorXd ukfApp:: PredictionModelMeasurement (const Eigen::Ref<const Eigen::VectorXd> &sig_pred_,
                                                     const void *args)
{
 ...
 *
 */
Eigen::VectorXd ukfApp:: calc_covar (const Eigen::Ref<const Eigen::VectorXd>&sig_pred)
{
 ...
 *
 */
Eigen::VectorXd ukfApp::calc_covar_measurement (const Eigen::Ref<const Eigen::VectorXd> &sig_pred)
{
    VectorXd x_diff;
    x_diff = sig_pred;
    //angle normalization

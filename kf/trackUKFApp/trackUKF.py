...
from trackUKFApp.tracker import TrackUKF
...
if __name__ == '__main__':
    ...
    #  Parse input file                                                             *
    # *******************************************************************************/
    fileName:str = "obj_pose-laser-radar-synthetic-input.txt"
    ...
    for counter in range(size):
        ...
        vx = trackf.kd.x[2] * math.cos(trackf.kd.x[3])
        vy = trackf.kd.x[2] * math.sin(trackf.kd.x[3])
        vxEstimated[counter] = vx
        vyEstimated[counter] = vy
        vEstimated[counter]  = trackf.kd.x[2]
